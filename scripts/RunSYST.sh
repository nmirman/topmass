...
#PBS -o results_2Dfit_syst_test1_20151111/output${JOBNUM}.txt
#PBS -j oe
...
#./DoFit --run_number ${JOBNUM} --syst ${syst[$JOBNUM]} --fit --masspnt 172.5 --mt2_221 --mbl --jfactor --outdir results_2Dfit_syst_test1_20151111
./DoFit --run_number ${JOBNUM} --syst ${syst[$JOBNUM]} --fit --masspnt 172.5 --mbl --outdir results_2Dfit_syst_test1_20151111
