...
#PBS -o results_mt2maossyst_20150526/output${JOBNUM}.txt
#PBS -j oe
...
./DoFit --run_number ${JOBNUM} --syst ${syst[$JOBNUM]} --fit --masspnt 172.5 --mt2_220 --maos210 --outdir results_mt2maossyst_20150526
