...
#PBS -o results_mbl221syst_20150802/output${JOBNUM}.txt
#PBS -j oe
...
./DoFit --run_number ${JOBNUM} --syst ${syst[$JOBNUM]} --fit --masspnt 172.5 --mt2_221 --mbl --outdir results_mbl221syst_20150802
