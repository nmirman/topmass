...
./DoFit --run_number $job --bootstrap --fit --masspnt ${mass[$iter]} --maos220
#./DoFit --run_number $job --bootstrap --fit --masspnt ${mass[$iter]} --mbl

#./DoFit --run_number $job --bootstrap --fit --masspnt 172.5 --mbl --numPE 20 --PE $iter
#./DoFit --run_number $job --bootstrap --fit --masspnt 166.5
#./DoFit --run_number $job --bootstrap --fit --masspnt ${mass[$iter]} --gnorm 30000
